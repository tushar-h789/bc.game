...
export default function Banner({
  ...
  return (
    <div className="bg-[#213744] p-4 rounded-lg flex items-center justify-between  mx-3 md:mx-0">
      {/* Left Side Content */}
      <div className="text-white flex flex-col">
        <h2 className="text-[16px] text-[#E2E5E7] bg-[#2F4553] p-1 rounded-[4px] max-w-[114px] font-semibold">
          {title}
        </h2>
