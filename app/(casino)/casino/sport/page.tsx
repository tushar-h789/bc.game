...
import ReUsableSportsSlider, {
  type MatchSlideData,
} from "../_components/re-usable/re-usable-sports-slider";
...
export default function Page() {
  return (
    <div>
      ...
      <div className="p-1">
        <ReUsableSportsSlider title="Upcoming Matches" slides={matches} />
      </div>
      <div>
        <PreMatch title="Top pre-match" slides={matches} />
      </div>
    </div>
  );
}
